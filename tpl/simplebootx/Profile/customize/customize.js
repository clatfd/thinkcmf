$("#qrtd").hover(function(){$('#qr').css('display','inline-block')},function(){ $('#qr').css('display','none')})
// var customizeURL = 'tpl/simplebootx/Profile/customize/api/',
//     customizeHTML = '\
...
// Modernizr.load([
//     'tpl/simplebootx/Profile/customize/customize.css',
//     {
//         'load': ['tpl/simplebootx/Profile/customize/underscore-min.js', 'tpl/simplebootx/Profile/customize/backbone.js'],
//         'complete': function() {
