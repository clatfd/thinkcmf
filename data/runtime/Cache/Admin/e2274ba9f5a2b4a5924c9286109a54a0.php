...
.list-dot li a.close,.list-dot-othors li a.close{ background: url("/ThinkCMFX1.5.0/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
      ...
      <table width="100%" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td>
			...
			<img src='/ThinkCMFX1.5.0/statics/images/icon/upload-pic.png' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
            <input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','/ThinkCMFX1.5.0/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
    ...
    <div class="table_full">
  	...
  	<div class="form-actions">
           <button class="btn btn-primary btn_submit J_ajax_submit_btn"type="submit">提交</button>
      		<a class="btn" href="/ThinkCMFX1.5.0/index.php/Admin/Slide">返回</a>
      </div>
 </form>
</div>
<script type="text/javascript" src="/ThinkCMFX1.5.0/statics/js/common.js"></script>
<script type="text/javascript" src="/ThinkCMFX1.5.0/statics/js/content_addtop.js"></script>
<script type="text/javascript"> 
$(function () {
										...
										button:[
											{
												...
												name: '返回列表',
												callback:function(){
													location.href="/ThinkCMFX1.5.0/index.php/Admin/Slide";
													return true;
												}
											}
										]
