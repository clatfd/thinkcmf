...
$configs= array(
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Blog','Todo','Sensor','Profile','Mailer','Wordlist','Calendar','Link','Travel','Movie'),
